...
const Flashcard = ({ flashcard, deleteFlashcard }) => {
  const [showFlashinfo, setShowAnswer] = useState(false);
  ...
  return (
    <div className="card">
        ...
        <div className="level">
          <div className="level-left">
            <div className="level-item p-2">
              <p className="buttons">
                <button className="button" type="button" onClick={() => setShowAnswer(!showFlashinfo)}>
      ...
      <ReactCardFlip isFlipped={showFlashinfo} flipDirection="vertical">
